...
Here we can see that Random Forest and boosting have an edge on the classification power against the other models.

Those are the only model where the box plot interquartile does not overlap.

...
Having the best score cut off out of each model we use **HMeasure()** function from **hmeasure** library to calculate the full set of metrics for classification methods.

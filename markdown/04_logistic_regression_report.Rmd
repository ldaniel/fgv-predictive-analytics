...
In general this model has not delivered a good accuracy, we will compare how it performe agaisnt other classes of models in the Final Report section.

```{r see_accuracy, echo=TRUE, out.width= '100%'}
# accuracy metrics ---------------------------------------------------------------
